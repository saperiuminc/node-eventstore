 ...
 * @returns {void} - returns void. use the callback for the result (cb)
 */
EventstorePlaybackListMySqlStore.prototype.query = function(listName, start, limit, filters, sort, cb) {
    this._query(listName, start, limit, filters, sort).then((results) => cb(null, results)).catch(cb);
};
 ...
 */
EventstorePlaybackListMySqlStore.prototype._query = async function(listName, start, limit, filters, sort) {
    try {
 ...
 * @returns {void} - returns void. use the callback for the result (cb)
 */
EventstorePlaybackListMySqlStore.prototype.add = function(listName, rowId, revision, data, meta, cb) {
    this._add(listName, rowId, revision, data, meta).then(cb).catch(cb);
};
 ...
 */
EventstorePlaybackListMySqlStore.prototype._add = async function(listName, rowId, revision, data, meta) {
    try {
 ...
 * @returns {void} - returns void. use the callback for the result (cb)
 */
EventstorePlaybackListMySqlStore.prototype.update = function(listName, rowId, revision, data, meta, cb) {
    this._update(listName, rowId, revision, data, meta).then(cb).catch(cb);
};
 ...
 * @returns {Promise<void>} - returns Promise of type void
 */
EventstorePlaybackListMySqlStore.prototype._update = async function(listName, rowId, revision, data, meta) {
    try {
 ...
 * @returns {void} - returns void. use the callback for the result (cb)
 */
EventstorePlaybackListMySqlStore.prototype.delete = function(listName, rowId, cb) {
    this._delete(listName, rowId).then(cb).catch(cb);
};
 ...
 * @returns {Promise<void>} - returns Promise of type void
 */
EventstorePlaybackListMySqlStore.prototype._delete = async function(listName, rowId) {
    try {
 ...
 * @returns {void} - returns void. use the callback for the result (cb)
 */
EventstorePlaybackListMySqlStore.prototype.get = function(listName, rowId, cb) {
    this._get(listName, rowId).then((item) => {
        cb(null, item);
    }).catch(cb);
};
 ...
 * @returns {Promise<void>} - returns Promise of type void
 */
EventstorePlaybackListMySqlStore.prototype._get = async function(listName, rowId) {
    try {
