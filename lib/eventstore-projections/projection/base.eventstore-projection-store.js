 ...
 */
 ...
 BaseEventstoreProjectionStore.prototype.getProjectionStreamVersion = async function(projectionId, context, aggregate, aggregateId) {
    throw new Error('getOffsetOfProjectionStreamCheckpoint not implemented');
}


/**
 * @param {String} projectionId the projectionId to update
 * @param {String} context the streamId to update
 * @param {String} aggregate the streamId to update
 * @param {String} streamId the streamId to update
 * @returns {Promise}
 */

 BaseEventstoreProjectionStore.prototype.updateProjectionStreamVersion = async function(projectionId, context, aggregate, aggregateId, version) {
    throw new Error('updateOffsetOfProjectionStreamCheckpoint not implemented');
  }
