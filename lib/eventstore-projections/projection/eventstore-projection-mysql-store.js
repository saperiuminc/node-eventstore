...
function EventstoreProjectionMysqlStore(options) {
  ...
  this.options.pool = Object.assign(defaultPool, options.pool);
...
EventstoreProjectionMysqlStore.prototype.createProjection = async function (projection) {
  ...
  await this._executeSqlQuery(query, [projection.projectionId, projection.configuration.projectionName, config, projection.context, projection.offset]);
};
