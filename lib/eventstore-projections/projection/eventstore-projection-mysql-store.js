...
EventstoreProjectionMysqlStore.prototype.init = async function () {
  ...
  if (!this._isInit) {
    ...
    // TODO: Ryan: Made partition nullable
...
EventstoreProjectionMysqlStore.prototype.createProjectionTask = async function (projectionTask) {
  ...
  // TODO: Ryan: Added null check for partition
 ...
 */
EventstoreProjectionMysqlStore.prototype.getProjectionTasks = async function (projectionId) {
  let query = `SELECT
                  pj.projection_task_id,
                  pj.projection_id,
                  pj.shard,
...
/**
 * Deletes a projection task that matches the specified projection task id
 * @param {String} projectionTaskId the projection task id of the projection task to delete
 * @returns {Promise<void>} - returns a Promise of type void
 */
 EventstoreProjectionMysqlStore.prototype.deleteProjectionTask = async function (projectionTaskId) {
  const query = `DELETE FROM ${this.options.projectionTasksTableName}
                    WHERE projection_task_id = ?;`;
  const params = [projectionTaskId];
