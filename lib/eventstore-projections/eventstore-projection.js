...
function EventstoreWithProjection(options, store) {
    ...
    if (options) {
        ...
        options.enableProjectionPublish = options.enableProjectionPublish === true ? true : false;
        options.enableProjectionSubscribe = options.enableProjectionSubscribe === true ? true : false;
...
EventstoreWithProjection.prototype.startAllProjections = function(callback) {
    try {
        ...
        if (this.options.enableProjectionSubscribe === false) {
            throw new Error('enableProjectionSubscribe true is required with startAllProjections');
        }
...
EventstoreWithProjection.prototype.subscribe = function(query, revision, onEventCallback, onErrorCallback) {
    ...
    try {
        ...
        if (this.options.enableProjectionSubscribe === false) {
            throw new Error('enableProjectionSubscribe true is required when subscribing');
        }
...
EventstoreWithProjection.prototype.setupNotifyPublish = async function() {
    return new Promise((resolve, reject) => {
        ...
        try {
            if (self.options.enableProjectionPublish === true && self.options.redisConfig && self.redisPub == undefined) {
...
EventstoreWithProjection.prototype._setupNotifySubscribe = async function() {
    return new Promise((resolve, reject) => {
        ...
        try {
            if (self.options.enableProjectionSubscribe === true && self.options.redisConfig && self.redisSub == undefined) {
