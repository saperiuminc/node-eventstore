 ...
 */
 EventstoreWithProjection.prototype.pauseProjection = function(projectionId, done) {
    try {
        this._projectionStore.setPaused(projectionId).then((data) => done(null, data)).catch(done);
    } catch (error) {
 ...
 * @returns {Promise}
 */
 EventstoreWithProjection.prototype.runProjection = function(projectionId, done) {
    try {
        this._projectionStore.setRunning(projectionId).then((data) => done(null, data)).catch(done);
    } catch (error) {
