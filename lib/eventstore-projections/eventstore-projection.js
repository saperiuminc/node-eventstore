...
EventstoreWithProjection.prototype.startAllProjections = function(callback) {
    try {
        ...
        if (this.options.enableProjectionSubscribe === true) {
            debug('did enableProjectionSubscribe true is required with startAllProjections');
            throw new Error('enableProjectionSubscribe true is required with startAllProjections');
        } else {
            debug('did not enableProjectionSubscribe true is required with startAllProjections');
        }
...
EventstoreWithProjection.prototype.subscribe = function(query, revision, onEventCallback) {
    try {
        ...
        if (this.options.enableProjectionSubscribe === true) {
            throw new Error('enableProjectionSubscribe true is required when susbcribing');
        }
