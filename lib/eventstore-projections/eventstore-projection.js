...
const SimpleEventSubscriptionQueryManager = require('../query-managers/simple-event-subscription-query-manager');
const StreamBufferedEventSubscriptionQueryManager = require('../query-managers/stream-buffered-event-subscription-query-manager');
