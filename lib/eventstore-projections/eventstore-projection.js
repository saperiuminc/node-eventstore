                        ...
                        if (projectionConfig.concurrentEventNames &&
                            ...
                            if (nextEvent) {
                                ...
                                if (nextEventName === eventName) {
                                    debug('event the same adding to batch', eventName, events.length)
                                } else {
                                    debug('event different ending the batch', nextEventName, eventName, events.length);
                                    endTheBatch = true;
                                }
                            } else {
                                debug('no next event. ending the batch', eventName, events.length);
                                endTheBatch = true;
                            }
