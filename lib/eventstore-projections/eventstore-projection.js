...
EventstoreWithProjection.prototype._processJob = async function(jobId, jobData, lastResult) {
    try {
        ...
        const projection = await this._projectionStore.getProjection(jobProjection.projectionId);
 ...
 * @returns {void} returns void
 */
EventstoreWithProjection.prototype._processCompletedJob = async function(jobId, jobData) {
    try {
