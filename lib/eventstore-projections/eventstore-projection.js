...
EventstoreWithProjection.prototype._startAllProjections = async function() {
    try {
        ...
        if (this._jobsManager) {
            ...
            await this._jobsManager.processJobGroup(this, jobGroup, {}, this._processGetEventsJob, this._processGetEventsCompletedJob);
            ...
            _.forOwn(this._projections, (value, key) => {
                for (let i = 0; i < this.options.playbackEventJobCount; i++) {
                    ...
                    playbackEventsJobGroupTasks.push(this._jobsManager.processJobGroup(this, jobGroup, {
                        concurrency: 1
...
EventstoreWithProjection.prototype._processPlaybackEventsJob = async function(jobId, jobData, lastResult) {
    try {
        debug('_processPlaybackEventsJob called', jobId, jobData, lastResult);
...
EventstoreWithProjection.prototype._processPlaybackEventsCompletedJob = function(jobId, jobData) {
    try {
        ...
        debug(`Playback event job completed with data`, jobId, jobData);
    } catch (error) {
...
EventstoreWithProjection.prototype._processGetEventsJob = async function(jobId, jobData, lastResult) {
    try {
        ...
        if (projection) {
            ...
            if (events) {
                debug('got events in getEventsAsync for playback:', events, events.length, projection.projectionId);
            }
