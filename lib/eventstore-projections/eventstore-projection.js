...
EventstoreWithProjection.prototype.registerPlaybackListView = function(listName, listQuery, totalCountQuery, opts, done) {
    ...
    this._registerPlaybackListView(listName, listQuery, totalCountQuery, alias, paginationPrimaryKeys, defaultPaginationPrimaryKeySortDirection).then(done).catch(done);
};
 ...
 * @returns {void} Returns void. Use the callback to the get playbacklist
 */
EventstoreWithProjection.prototype._registerPlaybackListView = async function(listName, listQuery, totalCountQuery, alias, paginationPrimaryKeys, defaultPaginationPrimaryKeySortDirection) {
    try {
