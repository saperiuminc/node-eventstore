...
function EventstoreWithProjection(options, store) {
    ...
    if (options) {
        ...
        options.enableNotifyPublish = options.enableNotifyPublish === true ? true : false;
        options.enableNotifySubscribe = options.enableNotifySubscribe === true ? true : false;
...
EventstoreWithProjection.prototype.setupNotifyPublish = async function() {
    return new Promise((resolve, reject) => {
        ...
        try {
            if (self.options.enableNotifyPublish === true && self.options.redisConfig && self.redisPub == undefined) {
...
EventstoreWithProjection.prototype._setupNotifySubscribe = async function() {
    return new Promise((resolve, reject) => {
        ...
        try {
            if (self.options.enableNotifySubscribe === true && self.options.redisConfig && self.redisSub == undefined) {
