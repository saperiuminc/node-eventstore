            ...
            while (currentAssignments.find((item) => item == projectionId) && currentRebalanceId === rebalanceId) {
                ...
                if (projection) {
                    ...
                    try {
                        ...
                        while (continueJob) {
                            try {
                                if (tryContinueProcessProjection == false) {
                                    const reason = await waitableConsumer.waitForSignal(self.options.pollingTimeout);
                                    console.log('es: reason', reason);
                                }
                        ...
                        if (waitableConsumer) {
                            console.log('stopWaitingForSignal called');
