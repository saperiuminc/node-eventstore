                                    ...
                                    if (tryContinueProcessProjectionTask == false) {
                                        ...
                                        if (!_.isEmpty(signalResult.messages)) {
                                            ...
                                            events.sort((event1, event2) => {
                                                return self._offsetManager.compareOffset(event1.eventSequence, event2.eventSequence);
                                            });

                                            const earliestEvent = events[0];
                                            if (projectionTask.offset != null && self._offsetManager.compareOffset(earliestEvent.eventSequence, projectionTask.offset) < 0) {
