...
class EventstoreWithProjection extends Eventstore {
    ...
    ***************************************************************************************************/
     ...
     */
    async _project(projectionConfig, shard = null, partition = null, shouldUpdateProjectionStore) {
        try {
            if (this.options.enableProjection === false) {
            ...
            if (shouldUpdateProjectionStore) {
                ...
                const projectionTask = await this._projectionStore.getProjectionTask(projection.projectionId, shard, partition);
                ...
                if (!projectionTask) {
                    ...
                    this._projectionStore.createProjectionTask(projection.projectionId, shard, partition, projectionTaskOffset)
                }
            }
