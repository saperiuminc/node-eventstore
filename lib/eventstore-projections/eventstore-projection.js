 ...
 */
 EventstoreWithProjection.prototype.registerPlaybackListView = function(listName, listQuery, totalCountQuery, opts, done) {
    ...
    if (done == undefined) {
        ...
        indexHints = opts.indexHints;
    }

    this._registerPlaybackListView(listName, listQuery, totalCountQuery, alias, paginationPrimaryKeys, defaultPaginationPrimaryKeySortDirection, indexHints).then(done).catch(done);
};
 ...
 * @returns {void} Returns void. Use the callback to the get playbacklist
 */
 EventstoreWithProjection.prototype._registerPlaybackListView = async function(listName, listQuery, totalCountQuery, alias, paginationPrimaryKeys, defaultPaginationPrimaryKeySortDirection, indexHints) {
    try {
