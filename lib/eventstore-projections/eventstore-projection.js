    ...
    async _processProjection(projectionTaskId) {
        ...
        try {
            ...
            if (projectionTask) {
                ...
                const projectionConfig = projectionTask.projection.configuration;
                let offset = projectionTask && projectionTask.offset ? this._deserializeProjectionOffset(projectionTask.offset)[0] : 0;
                if (isNaN(offset)) {
                    offset = 0;
                }
        ...
        try {
            ...
            if (shouldUpdateProjectionStore) {
                ...
                if (storedProjectionTasks.length === 0) {
                    ...
                    debug('ES-SHARD', this.options.shard, 'CREATING TASKS FOR PROJECTION', projectionConfig.projectionId, partitions);
