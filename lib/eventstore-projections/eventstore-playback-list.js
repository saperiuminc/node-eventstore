...
EventstorePlaybackList.prototype._stateListFiltersToFilterString = function(filters) {
  let filterString = '';
    ...
    _.forOwn(filterGroups, (filterGroup, group) => {
...
EventstorePlaybackList.prototype._stateListSortingToSortingString = function(sorting) {
    let sortingString = '';
