...
EventstorePlaybackList.prototype.add = function(rowId, revision, data, meta, cb) {
    ...
    // if (cb) {
    //     this._add(rowId, revision, data, meta).then((data) => {
    //         cb(null, data);
    //     }).catch(cb);
    // } else {
...
EventstorePlaybackList.prototype.update = function(rowId, revision, oldData, newData, meta, cb) {
    return (this._update(rowId, revision, oldData, newData, meta), cb);
    // if (cb) {
...
EventstorePlaybackList.prototype.delete = function(rowId, cb) {
    return (this._delete(rowId), cb);
    // if (cb) {
    //     this._delete(rowId).then((data) => {
    //         cb(null, data);
    //     }).catch(cb);
    // } else {
