 ...
 */
JobsManager.prototype.processJobGroup = function(owner, jobGroup, options, onProcessJob, onCompletedJob) {
    try {
...
JobsManager.prototype._getJobGroupsQueue = function(jobGroup) {
    ...
    if (!queue) {
        queue = this._jobGroupsQueue[jobGroup] = new this.options.BullQueue(jobGroup, { redis: this.options.redis.options });
    }
