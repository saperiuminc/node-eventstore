                ...
                await self.pool.execute(
                    ...
                    _getSnapshot: async function(query, revMax) {
                        ...
                        _getLatestOffset: async function(shard, partition) {
                            ...
                            return helpers.serializeProjectionOffset(latestOffset);
                        },
                        ...
                        _storedEventToEvent: function(storedEvent, query) {
                            const logicalEvent = {
                                ...
                                eventSequence: helpers.serializeProjectionOffset({
                        ...
                        _getEventsQueryBuilder: function(query, skip, limit) {
                            const self = this;
                            const bookmark = helpers.deserializeProjectionOffset(skip);
                            ...
                            queryString = queryString + ` ORDER BY id ASC LIMIT ?`
