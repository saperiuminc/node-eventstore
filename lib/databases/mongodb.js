...
_.extend(Mongo.prototype, {
  ...
  connect: function (callback) {
    ...
    let connectOptions = options.options;
    if (connectOptions && connectOptions.overrideConnectionOptions) {
      connectOptions = connectOptions.overrideConnectionOptions;
    }
    ...
    var client = mongo.MongoClient.connect(connectionUrl, connectOptions, function(err, cl) {
      if (err) {
        debug(err);
