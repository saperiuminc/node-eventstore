...
ClusteredCompositeOffsetManager.prototype = {
    ...
    compareEventOffset(event, offset) {
        ...
        if (Array.isArray(deserializedOffset)) {
            ...
            return this._leafOffsetManager.compareEventOffset(event, maxOffset);
        } else {
            return this._leafOffsetManager.compareEventOffset(event, offset);
        }
    }
}
