...
xdescribe('eventstore-playback-list-view tests', () => {
    ...
    describe('init', () => {
        describe('validating the options', () => {
            ...
            it('should validate for required parameter query', async (done) => {
                try {
                    options.query = null;
                    eventstorePlaybackList = new EventstorePlaybackListView(options);
                    await eventstorePlaybackList.init();
                } catch (error) {
                    expect(error.message).toEqual('query is required to be passed as part of the options');
                    done();
                }
            });
        })
        ...
        describe('creating the table', () => {
            it('should add the virtual columns/fields', async (done) => {
                ...
                expect(mysqlConnection.query).toHaveBeenCalledWith(`CREATE OR REPLACE VIEW list_name AS ${options.query}`, undefined, jasmine.any(Function));
                done();
            });
    ...
    describe('query', () => {
        ...
        describe('should do filtering', () => {
            ...
            it('should filter using "contains" filter type - case sensitive', async (done) => {
              // start, limit, filters, sort
              const start = 1;
              const limit = 10;
              const filters = [{
              ...
              await eventstorePlaybackList.init();
              eventstorePlaybackList.query(start, limit, filters, sort, function() {
                  expect(mysqlConnection.query).toHaveBeenCalledWith(`SELECT COUNT(1) as total_count FROM list_name WHERE 1 = 1  AND  ( field_1 LIKE BINARY '%Fols%' ) `, undefined, jasmine.any(Function));
                  expect(mysqlConnection.query).toHaveBeenCalledWith(`SELECT * FROM list_name WHERE 1 = 1  AND  ( field_1 LIKE BINARY '%Fols%' )   LIMIT ?,?`, [
                      start,
                      limit
                  ], jasmine.any(Function));
                  done();
            ...
            it('should filter using "contains" filter type - case insensitive', async (done) => {
              // start, limit, filters, sort
              const start = 1;
              const limit = 10;
              const filters = [{
            ...
            it('should filter using "startsWith" filter type - case sensitive', async (done) => {
              // start, limit, filters, sort
              const start = 1;
              const limit = 10;
              const filters = [{
            ...
            it('should filter using "startsWith" filter type - case insensitive', async (done) => {
              // start, limit, filters, sort
              const start = 1;
              const limit = 10;
              const filters = [{
            ...
            it('should filter using "endsWith" filter type - case insensitive', async (done) => {
              // start, limit, filters, sort
              const start = 1;
              const limit = 10;
              const filters = [{
              ...
              await eventstorePlaybackList.init();
              eventstorePlaybackList.query(start, limit, filters, sort, function() {
                  expect(mysqlConnection.query).toHaveBeenCalledWith(`SELECT COUNT(1) as total_count FROM list_name WHERE 1 = 1  AND  ( field_1 LIKE BINARY '%ring' ) `, undefined, jasmine.any(Function));
                  expect(mysqlConnection.query).toHaveBeenCalledWith(`SELECT * FROM list_name WHERE 1 = 1  AND  ( field_1 LIKE BINARY '%ring' )   LIMIT ?,?`, [
                      start,
                      limit
                  ], jasmine.any(Function));
                  done();
            ...
            it('should filter using "endsWith" filter type - case insensitive', async (done) => {
              ...
              await eventstorePlaybackList.init();
              eventstorePlaybackList.query(start, limit, filters, sort, function() {
                  expect(mysqlConnection.query).toHaveBeenCalledWith(`SELECT COUNT(1) as total_count FROM list_name WHERE 1 = 1  AND  ( field_1 LIKE  '%ing' ) `, undefined, jasmine.any(Function));
                  expect(mysqlConnection.query).toHaveBeenCalledWith(`SELECT * FROM list_name WHERE 1 = 1  AND  ( field_1 LIKE  '%ing' )   LIMIT ?,?`, [
                      start,
                      limit
                  ], jasmine.any(Function));
                  done();
