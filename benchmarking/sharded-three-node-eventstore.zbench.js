    ...
    z.setupOnce(async (done, b) => {
        ...
        while (connectCounter < connectCounterThreshold) {
            try {
                ...
                await mysqlConnection2.query('CREATE DATABASE IF NOT EXISTS eventstore;');
                await mysqlConnection2.end();

                const mysqlConnection3 = await mysql2.createConnection({
                    host: 'localhost',
                    port: '3308',
                    user: 'root',
                    password: 'root'
                ...
                await mysqlConnection3.query('CREATE DATABASE IF NOT EXISTS eventstore;');
                await mysqlConnection3.end();
